  ...
  return (
    <>
      ...
      <main className="isolate bg-white">
          ...
          <div className="mx-auto container px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <h1 className="max-w-2xl text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto">
                AL-KESAA GENERAL CONTRACTING EST.
              </h1>
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                  the Largest Manpower Service Company Provider operating from
                  the Eastern Province, the heart of oil industry in the Kingdom
                  of Saudi Arabia. It is a rapidly expanding organization
                  offering a wide range of Support services in terms of
                  providing Technical & Non-Technical Manpower Services in the
                  area of Construction, General Contracting, Industrial
                  Contracting, operation and Shut down Maintenance, support
                  Janitorial and General Services. In addition to our support
                  services, esad provides recruitment for Saudi citizens as well
                  as expatriates. As a result of our continuous pursuit for
                  recognition and devoted customer service, we have secured the
                  confidence and appreciation of our clients. We have qualified
                  and experienced Engineers, technicians and ministerial staffs
                  to deliver the best candidates to our clients.
                </p>
              </div>
              <img
                alt=""
                src="/images/construction-img-2.jpg"
        ...
        {/* Timeline section */}
        <div className="-mt-8 container px-6 lg:px-8">
        ...
        {/* Logo cloud */}
        <div className="mt-32 container sm:mt-40 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:max-w-none lg:min-w-full lg:flex-none lg:gap-y-8">
              ...
              <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                  <img
                    alt=""
                    src="/images/construction-img-1.jpg"
                ...
                <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
                  <div className="order-first flex w-64 flex-none justify-end self-end lg:w-auto">
                    <img
                      alt=""
                      src="/images/construction-img-5.jpg"
                  ...
                  <div className="flex w-96 flex-auto justify-end lg:w-auto lg:flex-none">
                    <img
                      alt=""
                      src="/images/construction-img-3.jpg"
                  ...
                  <div className="hidden sm:block sm:w-0 sm:flex-auto lg:w-auto lg:flex-none">
                    <img
                      alt=""
                      src="/images/construction-img-4.jpg"
        ...
        {/* Stats */}
        <div className="mt-32 container px-6 sm:mt-40 lg:px-8">
        ...
        {/* Content section */}
        <div className="my-32 container px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div className="w-full lg:max-w-lg lg:flex-auto">
              ...
              <img
                alt=""
                src="/images/construction-img-6.jpg"
